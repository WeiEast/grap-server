...
/**
 * @author Jerry
 * @date 2018-12-20 20:49
 */
public class RequestAdaptFilter extends AbstractRequestFilter {

    @Override
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        HttpServletRequest actualRequest = WrappedHttpServletRequest.wrap(request, null);
