 ...
 */
@Component
public class QueryAppCallBackBizAdapterImpl implements  QueryAppCallBackBizAdapter{
    private static final Logger logger = LoggerFactory.getLogger(QueryAppCallBackBizAdapterImpl.class);
