...
/**
 * @author Jerry
 * @date 2018/12/12 01:45
 */
@Service
public class AppCallbackConfigServiceImpl extends AbstractService implements InitializingBean, VariableMessageHandler,
    AppCallbackConfigService {
    @Autowired
    ...
    @Override
    public List<CallbackConfig> queryCallbackConfigsByAppIdAndBizType(String appId, Byte bizType,
        EDataType dataType) {
        // 1.查询所有回调
