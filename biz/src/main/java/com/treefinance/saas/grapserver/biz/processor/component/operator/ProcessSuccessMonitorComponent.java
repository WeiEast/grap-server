 ...
 */
@Component("processSuccessMonitorComponent")
public class ProcessSuccessMonitorComponent extends BaseBusinessComponent<OperatorMonitorSpecialRequest> {
    private final static Logger logger = LoggerFactory.getLogger(ProcessSuccessMonitorComponent.class);
...
//        logger.info("运营商监控,发送洗数成功(任务日志)消息到monitor,request={},message={},status={}",
//                JSON.toJSONString(request), JSON.toJSONString(message), ETaskOperatorMonitorStatus.PROCESS_SUCCESS);
